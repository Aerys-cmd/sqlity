...
/// <summary>
/// An in-memory <see cref="IPager"/> implementation that stores all pages in a dictionary.
/// Used when the data source is <c>":memory:"</c> so no file I/O occurs.
/// </summary>
public sealed class InMemoryPager : IPager
{
