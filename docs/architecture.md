...
- `Sqlity.Core`: started
- `Sqlity.Storage`: single-page storage engine, persisted catalog, and table-level row operations implemented
- `Sqlity.Query`: MVP SQL parser and executor implemented
